...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_eve_5flauncher_2fgateway_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_eve_5flauncher_2fgateway_2eproto {
...
class IPAddress final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:eve_launcher.gateway.IPAddress) */ {
 public:
  IPAddress();
  virtual ~IPAddress();
 ...
 private:
  ...
  friend struct ::TableStruct_eve_5flauncher_2fgateway_2eproto;
};
// -------------------------------------------------------------------

class Event final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:eve_launcher.gateway.Event) */ {
 public:
  Event();
  virtual ~Event();
...
class DefaultResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:eve_launcher.gateway.DefaultResponse) */ {
 public:
  DefaultResponse();
  ...
  inline DefaultResponse* New() const final {
    return CreateMaybeMessage<DefaultResponse>(nullptr);
  }
...
inline bool Event::has_launcher_event() const {
  return this != internal_default_instance() && launcher_event_ != nullptr;
}
inline const ::eve_launcher::Event& Event::launcher_event() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::eve_launcher::Event*>(
...
inline bool Event::has_launcher_ip_address() const {
  return this != internal_default_instance() && launcher_ip_address_ != nullptr;
}
...
inline const ::eve_launcher::gateway::IPAddress& Event::launcher_ip_address() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::eve_launcher::gateway::IPAddress*>(
...
inline ::eve_launcher::gateway::IPAddress* Event::mutable_launcher_ip_address() {
  ...
  if (launcher_ip_address_ == nullptr) {
